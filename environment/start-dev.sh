...
ssh -f -o "StrictHostKeyChecking no" -i .vagrant/machines/default/virtualbox/private_key -p 2222 vagrant@127.0.0.1 "cd /home/vagrant/project/nodeapp/db && knex migrate:latest && ls" 
echo gulp serve 
